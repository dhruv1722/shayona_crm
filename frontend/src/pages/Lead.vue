...
//   const message = `Hello ${doc.value.first_name || ''}, 
...
//   openWebsite(
//     `https://wa.me/${doc.value.mobile_no}?text=${encodedMessage}`
//   )
// }
...
async function openWhatsApp() {
  ...
  const message = `Hi ${doc.value.first_name || doc.value.name},

Warm greetings from Praveg Hotels! 🌿

We are reaching out regarding your recent booking inquiry with us. 
Our team is here to assist you with any details, special requests, or support you may need to make your stay comfortable and memorable.

Please feel free to reply to this message, and we’ll be happy to help you.

We look forward to welcoming you soon!

Best Regards,
Praveg Hotels Reservations Team`
